...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    """
    train_x, train_y, test_x, test_y = get_MNIST_data()
    train_y_mod3, test_y_mod3 = update_y(train_y=train_y, test_y=test_y)
    ...
    plot_cost_function_over_time(cost_function_history=cost_function_history)
...
theta, pc_cost_history = softmax_regression(
    train_pca,
    train_y,
    temp_parameter=0.5,
    alpha=0.3,
...
plot_cost_function_over_time(pc_cost_history)
